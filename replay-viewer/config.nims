...
switch(
  "passL",
  (&"""
  -o {distDir / "chorus_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=ChorusReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_ch_load_replay,_ch_payload_ptr,_ch_payload_len,_ch_error_ptr,_ch_error_len
  """).replace("\n", " ")
)
